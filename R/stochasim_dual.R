...
#a function to run stochasim using hydrographs and two flood generating mechanisms
stochasim_dual <- function(floods_snow,floods_rain, Q_base, n, d84, d50, width_0, slope, H) {
  rv_rate <- 0.1
