...
gbem <- function(Q, t, n, D84, D50, W, S, H = 0) {
    # INPUTS
    #   Q     discharge carried by the stream
    #   t     time for which Q acts on the stream channel (hrs)
    #   n     Manning's n value for the main channel
    #   D84   84th percentile of the surface grain size distribution (mm)
    #   D50   50th percentile of the grain size distribution (mm)
    #   W     water surface width at the beginning of time interval T
    #   S     energy gradient of the stream channel
    #   H     effective rooting depth for vegetation
              ...
              # more than 50% tree / shrub cover H = 1.1
    ...
    #step 3: return the predicted widening, widening constrained by vb, transp. volume, stable depth
